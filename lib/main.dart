        ...
        builder: (context, settings, _) {
          return AnnotatedRegion<SystemUiOverlayStyle>(
            ...
            child: MaterialApp(
              ...
              // Deliberately NOT wiring MaterialApp.locale to the user's
              // chosen app language: flutter_localizations doesn't ship
              // Material-widget translations for every language we
              // support (e.g. Tajik isn't implemented in Flutter itself
              // yet), and setting an unsupported locale there breaks
              // Material widgets app-wide. Our own UI text is fully
              // independent of this — see lib/l10n/app_text.dart.
